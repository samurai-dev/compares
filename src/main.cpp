...
uint256 hashGenesisBlock("0x81685325a2c36fa0be10bc9bc32ce69eac2d0c6e297d15ef7cc3443556fdc3aa");
...
const string strMessageMagic = "BitMoneycoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 60 * 60; // BitMoneycoin: 1 Hours
static const int64 nTargetSpacing = 300; // BitMoneycoin: 5 minute blocks
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlock *pblock)
{
    ...
    // BitMoneycoin: This fixes an issue where a 51% attack can change difficulty at will.
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal bitmoneycoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "BitMoneycoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x81685325a2c36fa0be10bc9bc32ce69eac2d0c6e297d15ef7cc3443556fdc3aa");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Day of the birthday of my dear wife, hard to forget ...";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1405814400; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2520110;

        if (fTestNet)
        {
            block.nTime    = 1398902400;
            block.nNonce   = 127176;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x473cbc89cf53c249b1efbba6a10e6eddcc9713583a44e9e6e35709c866d7799b"));
...
CBlock* CreateNewBlock(CReserveKey& reservekey)
{
    ...
    int64 nFees = 0;
    {
        ...
        while (!mapPriority.empty())
        {
            ...
            // BitMoneycoind: Reduce the exempted free transactions to 500 bytes (from Bitcoin's 3000 bytes)
