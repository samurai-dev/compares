...
static const char *strDNSSeed[][2] = {
    {"seed.bitmoneycoin.org", "seed.bitmoneycoin.org"},
    {"seed1.bitmoneycoin.org", "seed1.bitmoneycoin.org"},
    {"seed2.bitmoneycoin.org", "seed2.bitmoneycoin.org"},
    {"seed3.bitmoneycoin.org", "seed3.bitmoneycoin.org"},
    {"seed4.bitmoneycoin.org", "seed4.bitmoneycoin.org"},
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. BitMoneycoin is probably already running."), addrBind.ToString().c_str());
        else
